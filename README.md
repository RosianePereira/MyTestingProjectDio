...
### Testes e Resultados  
Durante a execução dos testes no Jira, foram capturadas evidências em imagens que demonstram tanto os casos de sucesso quanto os que apresentaram bugs, disponíveis na pasta [teste.png](Testes%20e%20Resultados/Evidências/teste.png) e [teste_com_bug.png](Testes%20e%20Resultados/Evidências/teste_com_bug.png)

Além disso, foram incluídos:  
- Gráficos de cobertura e status dos testes:[grafico_dos_testes.pdf](Testes%20e%20Resultados/Evidências/grafico_dos_testes.pdf).
- Resumo das observações e resultados:[ResultadosTestes.md](Testes%20e%20Resultados/Evidências/ResultadosTestes.md).
